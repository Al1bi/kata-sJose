...
const Singleton = (function() {
    ...
    function createInstance() {
        ...
        catalogo.agregarKata(new Kata(10,"ShortestPathMaze", "Given a 2D grid representing a maze, find the shortest path from a start point to an endpoint, if it exists.", 5));
        ...
        catalogo.agregarKata(new Kata(13,"JobScheduling", "Given an array of jobs with start times, end times, and profits, find the maximum profit obtainable by scheduling non-overlapping jobs.", 3));
        ...
        catalogo.agregarKata(new Kata(16,"CycleDetection", "Implement a function to detect if a cycle exists in a directed graph.", 3));
        ...
        catalogo.agregarKata(new Kata(19,"MaxFlowNetwork", "Given a graph representing a flow network, implement the Ford-Fulkerson algorithm to compute the maximum flow.", 5));
